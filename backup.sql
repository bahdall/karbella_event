...
-- Дамп структуры для таблица karbella_event.accounting1c
...
-- Дамп данных таблицы karbella_event.accounting1c: 0 rows
/*!40000 ALTER TABLE `accounting1c` DISABLE KEYS */;
/*!40000 ALTER TABLE `accounting1c` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.ActionLog
...
-- Дамп данных таблицы karbella_event.ActionLog: 25 rows
...
INSERT INTO `ActionLog` (`id`, `username`, `event`, `model_name`, `model_title`, `datetime`) VALUES
	...
	(10, 'admin', 1, 'SystemModules', 'events', '2015-07-07 17:00:14'),
	(11, 'admin', 3, 'SystemModules', 'events', '2015-07-07 17:15:22'),
	(12, 'admin', 1, 'SystemModules', 'events', '2015-07-07 17:15:27'),
	(13, 'admin', 1, 'SystemModules', 'poll', '2015-07-07 17:21:38'),
	(14, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:00:27'),
	(15, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:00:56'),
	(16, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:02:06'),
	(17, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:04:59'),
	(18, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:05:15'),
	(19, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:05:35'),
	(20, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:05:48'),
	(21, 'admin', 2, 'Page', 'За 8,5 месяцев Android 4.0 попал на 11% устройств', '2015-07-09 14:08:57'),
	(22, 'admin', 2, 'Page', 'За 8,5 месяцев Android 4.0 попал на 11% устройств', '2015-07-09 14:27:02'),
	(23, 'admin', 2, 'Page', 'Google презентовал свои очки дополненной реальности‎', '2015-07-09 14:27:17'),
	(24, 'admin', 2, 'Page', 'Samsung пытается избежать запрета на Galaxy Nexus', '2015-07-09 14:27:51'),
	(25, 'admin', 1, 'SystemModules', 'player', '2015-07-09 16:34:40'),
	(26, 'admin', 1, 'PageCategory', 'Галерея', '2015-07-11 16:22:00'),
	(27, 'admin', 2, 'PageCategory', 'Новости', '2015-07-11 16:22:00'),
	(28, 'admin', 2, 'PageCategory', 'Тесстовя2', '2015-07-11 16:22:00'),
	(29, 'admin', 2, 'PageCategory', 'Галерея', '2015-07-11 16:22:00'),
	(30, 'admin', 1, 'Page', 'Сольная программа Полины Гагариной “Спектакль” 28.02.2015', '2015-07-11 16:23:26'),
	(31, 'admin', 1, 'Page', 'Сольный концерт Максима Галкина 05.11.14', '2015-07-11 16:40:45');
/*!40000 ALTER TABLE `ActionLog` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.AuthAssignment
...
-- Дамп данных таблицы karbella_event.AuthAssignment: 8 rows
...
-- Дамп структуры для таблица karbella_event.AuthItem
...
-- Дамп данных таблицы karbella_event.AuthItem: 18 rows
...
-- Дамп структуры для таблица karbella_event.AuthItemChild
...
-- Дамп данных таблицы karbella_event.AuthItemChild: 0 rows
/*!40000 ALTER TABLE `AuthItemChild` DISABLE KEYS */;
/*!40000 ALTER TABLE `AuthItemChild` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.Banners
...
-- Дамп данных таблицы karbella_event.Banners: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.BannersImages
...
-- Дамп данных таблицы karbella_event.BannersImages: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.BannersImagesTranslate
...
-- Дамп данных таблицы karbella_event.BannersImagesTranslate: ~10 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.Comments
...
-- Дамп данных таблицы karbella_event.Comments: 0 rows
/*!40000 ALTER TABLE `Comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `Comments` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.Discount
...
-- Дамп данных таблицы karbella_event.Discount: 1 rows
...
-- Дамп структуры для таблица karbella_event.DiscountCategory
...
-- Дамп данных таблицы karbella_event.DiscountCategory: 9 rows
...
-- Дамп структуры для таблица karbella_event.DiscountManufacturer
...
-- Дамп данных таблицы karbella_event.DiscountManufacturer: 1 rows
...
-- Дамп структуры для таблица karbella_event.Event
...
-- Дамп данных таблицы karbella_event.Event: ~2 rows (приблизительно)
...
INSERT INTO `Event` (`id`, `title`, `meta_title`, `meta_keywords`, `meta_description`, `url`, `short_description`, `full_description`, `event_date`) VALUES
	(1, 'событие 1', '', '', '', 'sobitie-1', 'Великое событие в мире Авто', 'авыфавыфавыфавыфавыфа', '2015-07-12 12:04:22'),
	(2, 'событие 2', '', '', '', 'sobitie-2', 'Великое событие в мире Авто', 'выавыафыва', '2015-07-17 12:04:59'),
	(3, 'событие 3', '', '', '', 'sobitie-3', 'Великое событие в мире Авто', 'выфавыфавыавыавыфаыф', '2015-07-31 12:05:16');
/*!40000 ALTER TABLE `Event` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.EventImage
...
-- Дамп данных таблицы karbella_event.EventImage: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `EventImage` DISABLE KEYS */;
INSERT INTO `EventImage` (`id`, `event_id`, `image`) VALUES
	(1, 1, '1_837026727.jpg'),
	(2, 2, '2_-2134613622.jpg'),
	(3, 3, '3_-1272861471.jpg');
/*!40000 ALTER TABLE `EventImage` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.EventVideo
...
-- Дамп данных таблицы karbella_event.EventVideo: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `EventVideo` DISABLE KEYS */;
/*!40000 ALTER TABLE `EventVideo` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.grid_view_filter
...
-- Дамп данных таблицы karbella_event.grid_view_filter: 0 rows
/*!40000 ALTER TABLE `grid_view_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `grid_view_filter` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.notifications
...
-- Дамп данных таблицы karbella_event.notifications: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `notifications` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.Order
...
-- Дамп данных таблицы karbella_event.Order: 0 rows
/*!40000 ALTER TABLE `Order` DISABLE KEYS */;
/*!40000 ALTER TABLE `Order` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.OrderHistory
...
-- Дамп данных таблицы karbella_event.OrderHistory: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `OrderHistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `OrderHistory` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.OrderProduct
...
-- Дамп данных таблицы karbella_event.OrderProduct: 0 rows
/*!40000 ALTER TABLE `OrderProduct` DISABLE KEYS */;
/*!40000 ALTER TABLE `OrderProduct` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.OrderStatus
...
-- Дамп данных таблицы karbella_event.OrderStatus: 2 rows
...
-- Дамп структуры для таблица karbella_event.Page
...
CREATE TABLE IF NOT EXISTS `Page` (
  ...
  `view_image` tinyint(4) DEFAULT '0',
...
-- Дамп данных таблицы karbella_event.Page: 7 rows
/*!40000 ALTER TABLE `Page` DISABLE KEYS */;
INSERT INTO `Page` (`id`, `user_id`, `category_id`, `url`, `created`, `updated`, `publish_date`, `view_image`, `status`, `layout`, `view`) VALUES
	(8, 1, NULL, 'help', '2012-06-10 22:35:51', '2012-07-07 11:47:09', '2012-06-10 22:35:29', NULL, 'published', '', ''),
	(9, 1, NULL, 'how-to-create-order', '2012-06-10 22:36:50', '2012-07-07 11:45:53', '2012-06-10 22:36:27', NULL, 'published', '', ''),
	(10, 1, NULL, 'garantiya', '2012-06-10 22:37:06', '2012-07-07 11:45:38', '2012-06-10 22:36:50', NULL, 'published', '', ''),
	(11, 1, NULL, 'dostavka-i-oplata', '2012-06-10 22:37:18', '2012-07-07 11:41:49', '2012-06-10 22:37:07', NULL, 'published', '', ''),
	(12, 1, 7, 'samsung-pitaetsya-izbezhat-zapreta-na-galaxy-nexus-v-shtatah-pri-pomoshi-patcha', '2012-07-07 12:08:50', '2015-07-09 14:27:51', '2012-07-07 12:06:19', 1, 'published', '', ''),
	(13, 1, 7, 'za-85-mesyacev-android-40-popal-na-11-ustroistv', '2012-07-07 12:19:44', '2015-07-09 14:27:02', '2012-07-07 12:14:48', 1, 'published', '', ''),
	(14, 1, 7, 'google-prezentoval-svoi-ochki-dopolnennoi-realnosti', '2012-07-07 12:26:11', '2015-07-09 14:27:17', '2012-07-07 12:25:48', 1, 'published', '', ''),
	(15, 1, 13, 'solnaya-programma-polini-gagarinoi-spektakl-28022015', '2015-07-11 16:23:26', '2015-07-11 16:23:26', '2015-07-11 16:22:08', 1, 'published', '', ''),
	(16, 1, 13, 'solnii-koncert-maksima-galkina-051114', '2015-07-11 16:40:45', '2015-07-11 16:40:45', '2015-07-11 16:39:54', 1, 'published', '', '');
/*!40000 ALTER TABLE `Page` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PageCategory
...
-- Дамп данных таблицы karbella_event.PageCategory: 3 rows
...
INSERT INTO `PageCategory` (`id`, `parent_id`, `url`, `full_url`, `layout`, `view`, `created`, `updated`, `page_size`) VALUES
	...
	(13, NULL, 'galereya', 'galereya', '', '', '2015-07-11 16:22:00', '2015-07-11 16:22:00', 10);
/*!40000 ALTER TABLE `PageCategory` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PageCategoryTranslate
...
-- Дамп данных таблицы karbella_event.PageCategoryTranslate: 6 rows
...
-- Дамп структуры для таблица karbella_event.PageImage
...
-- Дамп данных таблицы karbella_event.PageImage: 5 rows
/*!40000 ALTER TABLE `PageImage` DISABLE KEYS */;
INSERT INTO `PageImage` (`id`, `page_id`, `name`, `is_main`, `uploaded_by`, `date_uploaded`, `title`) VALUES
	(6, 14, '14_1120539541.jpg', 0, 1, '2015-07-09 14:05:48', ''),
	(5, 14, '14_-648143522.jpg', 1, 1, '2015-07-09 14:05:15', ''),
	(7, 14, '14_-765183173.jpg', 0, 1, '2015-07-09 14:05:48', ''),
	(8, 13, '13_12035394.jpg', 1, 1, '2015-07-09 14:08:57', ''),
	(9, 12, '12_1116139407.jpg', 1, 1, '2015-07-09 14:27:51', NULL),
	(10, 15, '15_-668531575.jpg', 1, 1, '2015-07-11 16:23:26', NULL),
	(11, 15, '15_-1276643392.jpg', 0, 1, '2015-07-11 16:23:26', NULL),
	(12, 15, '15_2074790575.jpg', 0, 1, '2015-07-11 16:23:26', NULL),
	(13, 15, '15_928581207.jpg', 0, 1, '2015-07-11 16:23:26', NULL),
	(14, 16, '16_195102420.jpg', 1, 1, '2015-07-11 16:40:45', NULL),
	(15, 16, '16_661068634.jpg', 0, 1, '2015-07-11 16:40:45', NULL),
	(16, 16, '16_-171721639.jpg', 0, 1, '2015-07-11 16:40:45', NULL);
/*!40000 ALTER TABLE `PageImage` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PageTranslate
...
-- Дамп данных таблицы karbella_event.PageTranslate: 14 rows
...
INSERT INTO `PageTranslate` (`id`, `object_id`, `language_id`, `title`, `short_description`, `full_description`, `meta_title`, `meta_keywords`, `meta_description`) VALUES
	...
	(27, 14, 1, 'Google презентовал свои очки дополненной реальности‎', 'Компания Google приступит к продаже очков...', 'Очки будут стоить 1,5 тысячи долларов, и поставки стартуют в начале 2013 года. Устройство, однако, будет предназначено только для разработчиков. Оформить предварительный заказ на него смогут исключительно посетители конференции I/O, открывшейся 27 июня в Сан-Франциско. ', '', '', ''),
	(30, 15, 9, 'Сольная программа Полины Гагариной “Спектакль” 28.02.2015', '', '', '', '', ''),
...
DROP TABLE IF EXISTS `PlayerPlaylist`;
...
INSERT INTO `PlayerPlaylist` (`id`, `image`) VALUES
	(65, '/uploads/banners/f5c06bbc9a07c0536a38cca4f79cbe15.mp3.jpg');
/*!40000 ALTER TABLE `PlayerPlaylist` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PlayerPlaylistFiles
DROP TABLE IF EXISTS `PlayerPlaylistFiles`;
...
-- Дамп данных таблицы karbella_event.PlayerPlaylistFiles: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `PlayerPlaylistFiles` DISABLE KEYS */;
INSERT INTO `PlayerPlaylistFiles` (`id`, `playlist_id`, `file`, `sort`) VALUES
	(67, 65, '67_-908312222.mp3', 0),
	(68, 65, '68_-592045908.mp3', 1),
	(69, 65, '69_1613104198.mp3', 2),
	(70, 65, '70_-1418375615.mp3', 3);
/*!40000 ALTER TABLE `PlayerPlaylistFiles` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PlayerPlaylistFilesTranslate
DROP TABLE IF EXISTS `PlayerPlaylistFilesTranslate`;
...
-- Дамп данных таблицы karbella_event.PlayerPlaylistFilesTranslate: ~18 rows (приблизительно)
/*!40000 ALTER TABLE `PlayerPlaylistFilesTranslate` DISABLE KEYS */;
INSERT INTO `PlayerPlaylistFilesTranslate` (`id`, `object_id`, `language_id`, `name`) VALUES
	(107, 54, 1, 'test'),
	(108, 54, 9, 'test5'),
	(109, 55, 1, 'fdsafdsaf'),
	(110, 55, 9, 'fdsafdasfdas'),
	(113, 57, 1, 'gfdsgsf'),
	(114, 57, 9, 'gsdfgsdfgfsdgfsd'),
	(115, 58, 1, 'gsdfgf'),
	(116, 58, 9, 'gfdsgfsdg'),
	(129, 65, 1, 'fdsafdasf'),
	(130, 65, 9, 'fdsafdasf'),
	(131, 66, 1, 'fdsafdasf'),
	(132, 66, 9, 'fdsafdasf'),
	(133, 67, 1, 'Linkin Park - In The End'),
	(134, 67, 9, 'Linkin Park - In The End'),
	(135, 68, 1, 'Linkin Park - New Divide'),
	(136, 68, 9, 'Linkin Park - New Divide'),
	(137, 69, 1, 'Linkin Park - With You'),
	(138, 69, 9, 'Linkin Park - With You'),
	(139, 70, 1, 'Qwerty'),
	(140, 70, 9, 'Qwerty');
...
DROP TABLE IF EXISTS `PlayerPlaylistTranslate`;
...
-- Дамп данных таблицы karbella_event.PlayerPlaylistTranslate: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `PlayerPlaylistTranslate` DISABLE KEYS */;
INSERT INTO `PlayerPlaylistTranslate` (`id`, `object_id`, `language_id`, `name`, `description`) VALUES
	(129, 65, 1, 'Linkin Park', ''),
	(130, 65, 9, 'Linkin Park', '');
/*!40000 ALTER TABLE `PlayerPlaylistTranslate` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.Poll
...
-- Дамп данных таблицы karbella_event.Poll: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `Poll` DISABLE KEYS */;
INSERT INTO `Poll` (`id`, `name`, `description`, `status`) VALUES
	(4, 'Улугбек дибил?', 'test', 1);
/*!40000 ALTER TABLE `Poll` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PollChoice
...
-- Дамп данных таблицы karbella_event.PollChoice: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.PollChoiceTranslate
DROP TABLE IF EXISTS `PollChoiceTranslate`;
...
-- Дамп данных таблицы karbella_event.PollChoiceTranslate: ~6 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.PollTranslate
DROP TABLE IF EXISTS `PollTranslate`;
...
-- Дамп данных таблицы karbella_event.PollTranslate: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `PollTranslate` DISABLE KEYS */;
INSERT INTO `PollTranslate` (`id`, `object_id`, `language_id`, `name`) VALUES
	(10, 4, 1, 'Улугбек дибил?'),
	(11, 4, 9, 'Улугбек дибил?');
/*!40000 ALTER TABLE `PollTranslate` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.PollVote
...
CREATE TABLE IF NOT EXISTS `PollVote` (
  ...
  `time` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_PollVote_Poll` (`poll_id`),
  CONSTRAINT `FK_PollVote_Poll` FOREIGN KEY (`poll_id`) REFERENCES `Poll` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы karbella_event.PollVote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `PollVote` DISABLE KEYS */;
INSERT INTO `PollVote` (`id`, `poll_id`, `choice_id`, `user_id`, `ip_address`, `time`) VALUES
	(17, 4, 20, 1, '', '2015-07-09');
/*!40000 ALTER TABLE `PollVote` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.Rights
...
-- Дамп данных таблицы karbella_event.Rights: 0 rows
/*!40000 ALTER TABLE `Rights` DISABLE KEYS */;
/*!40000 ALTER TABLE `Rights` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.StoreAttribute
...
-- Дамп данных таблицы karbella_event.StoreAttribute: 19 rows
...
-- Дамп структуры для таблица karbella_event.StoreAttributeOption
...
-- Дамп данных таблицы karbella_event.StoreAttributeOption: 75 rows
...
-- Дамп структуры для таблица karbella_event.StoreAttributeOptionTranslate
...
-- Дамп данных таблицы karbella_event.StoreAttributeOptionTranslate: 150 rows
...
-- Дамп структуры для таблица karbella_event.StoreAttributeTranslate
...
-- Дамп данных таблицы karbella_event.StoreAttributeTranslate: 38 rows
...
-- Дамп структуры для таблица karbella_event.StoreCategory
...
-- Дамп данных таблицы karbella_event.StoreCategory: 9 rows
...
-- Дамп структуры для таблица karbella_event.StoreCategoryTranslate
...
-- Дамп данных таблицы karbella_event.StoreCategoryTranslate: 22 rows
...
-- Дамп структуры для таблица karbella_event.StoreCurrency
...
-- Дамп данных таблицы karbella_event.StoreCurrency: 2 rows
...
-- Дамп структуры для таблица karbella_event.StoreDeliveryMethod
...
-- Дамп данных таблицы karbella_event.StoreDeliveryMethod: 3 rows
...
-- Дамп структуры для таблица karbella_event.StoreDeliveryMethodTranslate
...
-- Дамп данных таблицы karbella_event.StoreDeliveryMethodTranslate: 6 rows
...
-- Дамп структуры для таблица karbella_event.StoreDeliveryPayment
...
-- Дамп данных таблицы karbella_event.StoreDeliveryPayment: 19 rows
...
-- Дамп структуры для таблица karbella_event.StoreManufacturer
...
-- Дамп данных таблицы karbella_event.StoreManufacturer: 18 rows
...
-- Дамп структуры для таблица karbella_event.StoreManufacturerTranslate
...
-- Дамп данных таблицы karbella_event.StoreManufacturerTranslate: 36 rows
...
-- Дамп структуры для таблица karbella_event.StorePaymentMethod
...
-- Дамп данных таблицы karbella_event.StorePaymentMethod: 5 rows
...
-- Дамп структуры для таблица karbella_event.StorePaymentMethodTranslate
...
-- Дамп данных таблицы karbella_event.StorePaymentMethodTranslate: 10 rows
...
-- Дамп структуры для таблица karbella_event.StoreProduct
...
-- Дамп данных таблицы karbella_event.StoreProduct: 44 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductAttributeEAV
...
-- Дамп данных таблицы karbella_event.StoreProductAttributeEAV: 183 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductCategoryRef
...
-- Дамп данных таблицы karbella_event.StoreProductCategoryRef: 70 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductConfigurableAttributes
...
-- Дамп данных таблицы karbella_event.StoreProductConfigurableAttributes: 0 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductConfigurations
...
-- Дамп данных таблицы karbella_event.StoreProductConfigurations: 0 rows
/*!40000 ALTER TABLE `StoreProductConfigurations` DISABLE KEYS */;
/*!40000 ALTER TABLE `StoreProductConfigurations` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.StoreProductImage
...
-- Дамп данных таблицы karbella_event.StoreProductImage: 44 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductTranslate
...
-- Дамп данных таблицы karbella_event.StoreProductTranslate: 88 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductType
...
-- Дамп данных таблицы karbella_event.StoreProductType: 6 rows
...
-- Дамп структуры для таблица karbella_event.StoreProductVariant
...
-- Дамп данных таблицы karbella_event.StoreProductVariant: 0 rows
/*!40000 ALTER TABLE `StoreProductVariant` DISABLE KEYS */;
/*!40000 ALTER TABLE `StoreProductVariant` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.StoreRelatedProduct
...
-- Дамп данных таблицы karbella_event.StoreRelatedProduct: 0 rows
/*!40000 ALTER TABLE `StoreRelatedProduct` DISABLE KEYS */;
/*!40000 ALTER TABLE `StoreRelatedProduct` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.StoreTypeAttribute
...
-- Дамп данных таблицы karbella_event.StoreTypeAttribute: 19 rows
...
-- Дамп структуры для таблица karbella_event.StoreWishlist
...
-- Дамп данных таблицы karbella_event.StoreWishlist: 0 rows
/*!40000 ALTER TABLE `StoreWishlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `StoreWishlist` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.StoreWishlistProducts
...
-- Дамп данных таблицы karbella_event.StoreWishlistProducts: 0 rows
/*!40000 ALTER TABLE `StoreWishlistProducts` DISABLE KEYS */;
/*!40000 ALTER TABLE `StoreWishlistProducts` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.SystemLanguage
...
-- Дамп данных таблицы karbella_event.SystemLanguage: 2 rows
...
-- Дамп структуры для таблица karbella_event.SystemLayouts
...
-- Дамп данных таблицы karbella_event.SystemLayouts: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.SystemLayoutsWidgets
...
-- Дамп данных таблицы karbella_event.SystemLayoutsWidgets: ~2 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.SystemModules
...
-- Дамп данных таблицы karbella_event.SystemModules: 21 rows
...
-- Дамп структуры для таблица karbella_event.SystemSettings
...
-- Дамп данных таблицы karbella_event.SystemSettings: 41 rows
...
-- Дамп структуры для таблица karbella_event.SystemWidgets
...
-- Дамп данных таблицы karbella_event.SystemWidgets: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.tbl_migration
...
-- Дамп данных таблицы karbella_event.tbl_migration: ~13 rows (приблизительно)
...
-- Дамп структуры для таблица karbella_event.user
...
-- Дамп данных таблицы karbella_event.user: 1 rows
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `created_at`, `last_login`, `login_ip`, `recovery_key`, `recovery_password`, `discount`, `banned`) VALUES
	(1, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@mail.ru', '2015-03-25 12:44:10', '2015-07-09 11:40:35', '127.0.0.1', NULL, NULL, NULL, 0);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;


-- Дамп структуры для таблица karbella_event.user_profile
...
-- Дамп данных таблицы karbella_event.user_profile: 1 rows
