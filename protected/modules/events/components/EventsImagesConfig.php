...
class EventsImagesConfig
{
	...
	public static $defaults = array(
			// Overrided from db
			'path'               => 'webroot.uploads.event',
			'thumbPath'          => 'webroot.assets.eventThumbs',
			'url'                => '/uploads/event/', // With ending slash
			'thumbUrl'           => '/assets/eventThumbs/', // With ending slash
